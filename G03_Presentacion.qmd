...
**P(1) + P(2) + P(3) + P(4) + P(5) + P(6) + P(7) + P(8) + P(9) + P(10) = 487/1373 + 462/1373 + 231/1373 + 103/1373 + 43/1373 + 24/1373 + 9/1373 + 5/1373 + 4/1373 + 5/1373 = 1373**
...
**P(Puede Mejorar) + P(Regular) + P(Bueno) + P(Excelente)** = **106/1422 + 317/1422 + 794/1422** + **205/1422 = 1422**
...
P(Regular): 134/1301\
P(Bueno): 783/1301\
P(Excelente): 365/1301**

### Comprobación:

**P(Malo) + P(Regular) + P(Bueno) + P(Excelente) = 19/1301 + 134/1301 + 783/1301 + 365/1301 = 1301**
...
**P(Bajo) + P(Medio) + P(Alto) + P(Muy_Alto) = 483/1410 + 731/1410 + 168/1410 + 28/1410 = 1410**
...
-   **P(C) = 0.13**: Un 13% de los participantes tiene un gasto monetario clasificado como "Alto". Esto podría indicar que el consumo de café es parte de un estilo de vida más costoso en términos de gasto personal, lo que podría tener implicaciones en su rendimiento académico.
